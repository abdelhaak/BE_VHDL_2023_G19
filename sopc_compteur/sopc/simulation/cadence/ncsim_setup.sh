...
# ACDS 18.1 625 win32 2023.09.21.11:13:47
...
# ----------------------------------------
# If sopc is one of several IP cores in your
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/sopc_RAM.hex ./
  cp -f $QSYS_SIMDIR/submodules/sopc_CPU_ociram_default_contents.dat ./
  cp -f $QSYS_SIMDIR/submodules/sopc_CPU_ociram_default_contents.hex ./
  cp -f $QSYS_SIMDIR/submodules/sopc_CPU_ociram_default_contents.mif ./
  cp -f $QSYS_SIMDIR/submodules/sopc_CPU_rf_ram_a.dat ./
  cp -f $QSYS_SIMDIR/submodules/sopc_CPU_rf_ram_a.hex ./
  cp -f $QSYS_SIMDIR/submodules/sopc_CPU_rf_ram_a.mif ./
  cp -f $QSYS_SIMDIR/submodules/sopc_CPU_rf_ram_b.dat ./
  cp -f $QSYS_SIMDIR/submodules/sopc_CPU_rf_ram_b.hex ./
  cp -f $QSYS_SIMDIR/submodules/sopc_CPU_rf_ram_b.mif ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sopc_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv" -work error_adapter_0                              -cdslib ./cds_libs/error_adapter_0.cds.lib                             
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/sopc_mm_interconnect_0_avalon_st_adapter.vhd"                -work avalon_st_adapter                            -cdslib ./cds_libs/avalon_st_adapter.cds.lib                           
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sopc_mm_interconnect_0_rsp_mux.sv"                           -work rsp_mux                                      -cdslib ./cds_libs/rsp_mux.cds.lib                                     
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sopc_mm_interconnect_0_rsp_demux.sv"                         -work rsp_demux                                    -cdslib ./cds_libs/rsp_demux.cds.lib                                   
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sopc_mm_interconnect_0_cmd_mux.sv"                           -work cmd_mux                                      -cdslib ./cds_libs/cmd_mux.cds.lib                                     
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sopc_mm_interconnect_0_cmd_demux.sv"                         -work cmd_demux                                    -cdslib ./cds_libs/cmd_demux.cds.lib                                   
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sopc_mm_interconnect_0_router_002.sv"                        -work router_002                                   -cdslib ./cds_libs/router_002.cds.lib                                  
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sopc_mm_interconnect_0_router.sv"                            -work router                                       -cdslib ./cds_libs/router.cds.lib                                      
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sopc_irq_mapper.sv"                                          -work irq_mapper                                   -cdslib ./cds_libs/irq_mapper.cds.lib                                  
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/sopc_mm_interconnect_0.v"                                    -work mm_interconnect_0                            -cdslib ./cds_libs/mm_interconnect_0.cds.lib                           
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/sopc_sysid_qsys_0.v"                                         -work sysid_qsys_0                                 -cdslib ./cds_libs/sysid_qsys_0.cds.lib                                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/sopc_leds.vhd"                                               -work leds                                         -cdslib ./cds_libs/leds.cds.lib                                        
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/sopc_jtag_uart_0.vhd"                                        -work jtag_uart_0                                  -cdslib ./cds_libs/jtag_uart_0.cds.lib                                 
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/sopc_boutons.vhd"                                            -work boutons                                      -cdslib ./cds_libs/boutons.cds.lib                                     
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/sopc_RAM.vhd"                                                -work RAM                                          -cdslib ./cds_libs/RAM.cds.lib                                         
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/sopc_CPU.vhd"                                                -work CPU                                          -cdslib ./cds_libs/CPU.cds.lib                                         
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/sopc_CPU_jtag_debug_module_sysclk.vhd"                       -work CPU                                          -cdslib ./cds_libs/CPU.cds.lib                                         
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/sopc_CPU_jtag_debug_module_tck.vhd"                          -work CPU                                          -cdslib ./cds_libs/CPU.cds.lib                                         
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/sopc_CPU_jtag_debug_module_wrapper.vhd"                      -work CPU                                          -cdslib ./cds_libs/CPU.cds.lib                                         
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/sopc_CPU_oci_test_bench.vhd"                                 -work CPU                                          -cdslib ./cds_libs/CPU.cds.lib                                         
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/sopc_CPU_test_bench.vhd"                                     -work CPU                                          -cdslib ./cds_libs/CPU.cds.lib                                         
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/sopc.vhd"                                                                                                                                                                                         
fi
