...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../avaloon_cmps.sopcinfo
...
# Design Name 
# setting SOPC_NAME is avaloon_cmps
SOPC_NAME := avaloon_cmps
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1701882753
SOPC_SYSID_FLAG += --timestamp=1701882753
ELF_PATCH_FLAG  += --timestamp 1701882753
