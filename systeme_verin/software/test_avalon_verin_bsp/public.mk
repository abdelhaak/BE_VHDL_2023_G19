...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../avalon_verin.sopcinfo
...
# Design Name 
# setting SOPC_NAME is avalon_verin
SOPC_NAME := avalon_verin
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1701535314
SOPC_SYSID_FLAG += --timestamp=1701535314
ELF_PATCH_FLAG  += --timestamp 1701535314
