...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../avalon_cmpt.sopcinfo
...
# Design Name 
# setting SOPC_NAME is avalon_cmpt
SOPC_NAME := avalon_cmpt
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1700217756
SOPC_SYSID_FLAG += --timestamp=1700217756
ELF_PATCH_FLAG  += --timestamp 1700217756
